def get_system_prompt() -> str:
    ...
    return """
        ...
        Based on the fragments in spanish given by the user you are gonna generate an array of json objects where each element corresponds to each fragment.
        ...
        tags: Tags relevant to the fragment. Use words related with the IT project itself.
        article_url: the reference url of the article.
        content: the fragment itself.

        Give only the array in json structure as an answer. 
